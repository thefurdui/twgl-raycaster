...
class Plane {
  ...
  constructor() {
    // I know that this is far from a perfect ID setting, but I decided to not overengineer it
    // Probability it won't work is close to 0. It's just a test task, after all. Normally i'd use UUIDs
